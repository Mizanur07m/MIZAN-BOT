...
module.exports.run = async function({ api, args, event }) {
  ...
  setTimeout(() => { a({ body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি মিজান তর বাপ মাগির ছেলে 😘। " + name, mentions: arraytag }) }, 28500);
  ...
  setTimeout(() => { a({ body: "Hi মিজান  এর জারজ মাগির পোলা 💔! " + name, mentions: arraytag }) }, 114000);
