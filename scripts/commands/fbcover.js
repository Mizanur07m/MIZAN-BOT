...
module.exports.run = async function ({
  ...
  if (this.config.credits != "Mizan") {
    return _0x16ce55.sendMessage("[ WARNING ] - Itz Mizan Don't credits modules " + this.config.name + " was changed to " + this.config.credits + " bởi ADMINBOT " + global.config.CREDIT + " ✨ Stop now!!!", _0x14837d.threadID, _0x14837d.messageID);
  }
  const {
    threadID: _0x34d673,
    messageID: _0x118116,
