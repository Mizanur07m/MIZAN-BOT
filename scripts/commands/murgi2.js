module.exports.config = {
  ...
  credits: "MIZAN",
  prefix: true,
  description: "Reply or tag a girl to roast",
  category: "prefix",
  usages: "[tag/reply]",
  cooldowns: 5
};
...
module.exports.run = async function({ api, args, event }) {
  ...
  setTimeout(() => { a({ body: "খাংকির মেয়ে তর কচি ভুদায় ভুদায় কামর দিমু 💔! " + name, mentions: arraytag }) }, 9000);
  ...
  setTimeout(() => { a({ body: "তর আম্মু রে আচার এর লোভ দেখি চুদি মাগির মেয়ে🤬 " + name, mentions: arraytag }) }, 17000);
  setTimeout(() => { a({ body: "বান্দির মেয়ে তর কচি বোনের ভুদা ফাক কর থুতু দিয়ে ভুদায় দন ডুকামু 🤟 " + name, mentions: arraytag }) }, 20000);
  setTimeout(() => { a({ body: "বান্দি মাগির মেয়ে তর আম্মু রে চুদি তর দুলা ভাই এর কান্দে ফেলে 🤝 " + name, mentions: arraytag }) }, 23000);
  setTimeout(() => { a({ body: "উফফফ খাদ্দামা মাগির মেয়ে তর আম্মুর কালা ভুদায় আমার মাল আউট তর কচি বোন রে উপ্তা করে এবার চুদবো 💉। " + name, mentions: arraytag }) }, 25000);
  setTimeout(() => { a({ body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির মেয়ে এমন চুদা দিমু লাইফ টাইম মনে রাখভি মিজান তর বাপ মাগির মেয়ে 😘। " + name, mentions: arraytag }) }, 28500);
  ...
  setTimeout(() => { a({ body: "ব্যাশ্যা মাগির মেয়ে 💔! " + name, mentions: arraytag }) }, 54000);
  setTimeout(() => { a({ body: "পতিতা মাগির মেয়ে " + name, mentions: arraytag }) }, 57000);
  setTimeout(() => { a({ body: "তর মারে চুদি " + name, mentions: arraytag }) }, 63000);
  setTimeout(() => { a({ body: "নাট বল্টু মাগির মেয়ে🤟 " + name, mentions: arraytag }) }, 66000);
  ...
  setTimeout(() => { a({ body: "কামলা মাগির মেয়ে ✋ " + name, mentions: arraytag }) }, 81000);
  setTimeout(() => { a({ body: "বাস্ট্রাড এর বাচ্ছা বস্তির মেয়ে " + name, mentions: arraytag }) }, 87000);
  setTimeout(() => { a("~ আমার জারজ শন্তান🤖") }, 93000);
  setTimeout(() => { a({ body: "Welcome মাগির মেয়ে 🥰। " + name, mentions: arraytag }) }, 99000);
  setTimeout(() => { a({ body: "তর কচি বোন এর পম পম😍.. " + name, mentions: arraytag }) }, 105000);
  setTimeout(() => { a({ body: "ব্যাস্যার মেয়ে কথা শুন তর আম্মু রে চুদি গামছা পেচিয়ে🐰 " + name, mentions: arraytag }) }, 111000);
  setTimeout(() => { a({ body: "Hi মিজান এর জারজ মাগির মেয়ে 💔! " + name, mentions: arraytag }) }, 114000);
  setTimeout(() => { a({ body: "২০ টাকা এ পতিতা মাগির মেয়ে " + name, mentions: arraytag }) }, 120000);
  setTimeout(() => { a({ body: "বস্তির মেয়ে অনলাইনের কিং " + name, mentions: arraytag }) }, 132000);
  setTimeout(() => { a({ body: "টুকাই মাগির মেয়ে🤟 " + name, mentions: arraytag }) }, 138000);
  setTimeout(() => { a({ body: "তর আম্মু রে পায়জামা খুলে চুদি 🤣 " + name, mentions: arraytag }) }, 144000);
  setTimeout(() => { a({ body: "হিজলা মাগির মেয়ে ✋ " + name, mentions: arraytag }) }, 162000);
  ...
  setTimeout(() => { a("~ আমার মেয়ে। জা ভাগ🤖") }, 220000);
};
